...
\NormalTok{epsilon =}\StringTok{ }\KeywordTok{list}\NormalTok{()}
\NormalTok{cosine_term =}\StringTok{ }\KeywordTok{list}\NormalTok{()}

\CommentTok{# betas estimation}
\NormalTok{beta1_est =}\StringTok{ }\KeywordTok{list}\NormalTok{()}
\NormalTok{beta2_est =}\StringTok{ }\KeywordTok{list}\NormalTok{()}
...
\NormalTok{    eps =}\StringTok{ }\KeywordTok{c}\NormalTok{()}
\NormalTok{    cos_t =}\StringTok{ }\KeywordTok{c}\NormalTok{()}
    \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\DecValTok{100}\NormalTok{) \{}
\NormalTok{        eps =}\StringTok{ }\KeywordTok{c}\NormalTok{(eps, }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{1}\NormalTok{))}
\NormalTok{        cos_t =}\StringTok{ }\KeywordTok{c}\NormalTok{(cos_t, }\KeywordTok{cos}\NormalTok{(i}\OperatorTok{/}\DecValTok{10} \OperatorTok{+}\StringTok{ }\NormalTok{phi))}
\NormalTok{        run =}\StringTok{ }\NormalTok{beta1 }\OperatorTok{+}\StringTok{ }\NormalTok{beta2}\OperatorTok{*}\NormalTok{cos_t[i] }\OperatorTok{+}\StringTok{ }\NormalTok{eps[i]}
\NormalTok{        vals =}\StringTok{ }\KeywordTok{c}\NormalTok{(vals, run)}
\NormalTok{    \}}
\NormalTok{    sim[[j]] =}\StringTok{ }\NormalTok{vals}
\NormalTok{    epsilon[[j]] =}\StringTok{ }\NormalTok{eps}
\NormalTok{    cosine_term[[j]] =}\StringTok{ }\NormalTok{cos_t}
\NormalTok{    beta1_est[[j]] =}\StringTok{ }\KeywordTok{mean}\NormalTok{(sim[[j]]) }\OperatorTok{-}\StringTok{ }\NormalTok{beta2}\OperatorTok{*}\KeywordTok{mean}\NormalTok{(cosine_term[[j]]) }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(epsilon[[j]])}
\NormalTok{    beta2_est[[j]] =}\StringTok{ }\NormalTok{(}\KeywordTok{mean}\NormalTok{(sim[[j]]) }\OperatorTok{-}\StringTok{ }\NormalTok{beta1 }\OperatorTok{-}\StringTok{ }\KeywordTok{mean}\NormalTok{(epsilon[[j]]))}\OperatorTok{/}\KeywordTok{mean}\NormalTok{(cosine_term[[j]])}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
