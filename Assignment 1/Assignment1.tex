...
\CommentTok{#> [1] 2.999202 3.001828}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}   }
\CommentTok{#> [1] "beta  1  hat has a relative error of:  0.000266043077609505"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  0.000609187194069142"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(means)}
\CommentTok{#> [1] 2.975611 3.015867}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(means)) \{}
    \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"beta "}\NormalTok{,i, }\StringTok{" hat has a relative error of: "}\NormalTok{, }\KeywordTok{abs}\NormalTok{(means[i]}\OperatorTok{-}\NormalTok{betas[i])}\OperatorTok{/}\NormalTok{betas[i]))}
\NormalTok{\}}
\CommentTok{#> [1] "beta  1  hat has a relative error of:  0.00812972909057604"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  0.00528905070142072"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(means)}
\CommentTok{#> [1] 4.0127848 0.1069866}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(means)) \{}
    \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"beta "}\NormalTok{,i, }\StringTok{" hat has a relative error of: "}\NormalTok{, }\KeywordTok{abs}\NormalTok{(means[i]}\OperatorTok{-}\NormalTok{betas[i])}\OperatorTok{/}\NormalTok{betas[i]))}
\NormalTok{\}}
\CommentTok{#> [1] "beta  1  hat has a relative error of:  0.33759492181668"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  0.964337788957008"}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{proof-that-varhatbeta_ols-geq-varhatbeta_ridge}{%
\subsection{\texorpdfstring{Proof that
\(Var(\hat{\beta_{OLS}}) \geq Var(\hat{\beta_{ridge}})\)}{Proof that Var(\textbackslash{}hat\{\textbackslash{}beta\_\{OLS\}\}) \textbackslash{}geq Var(\textbackslash{}hat\{\textbackslash{}beta\_\{ridge\}\})}}\label{proof-that-varhatbeta_ols-geq-varhatbeta_ridge}}

\(Var(\hat{\beta}) = \sigma^{2} (X^{\prime} X)^{-1}\)

\(\hat{\beta_{\lambda}} = (X^{\prime} X + \lambda I)^{-1} X^{\prime} Y \\ = (X^{\prime} X + \lambda I)^{-1} X^{\prime} X (X^{\prime} X + \lambda I)^{-1} X^{\prime} Y \\ = (X^{\prime} X + \lambda I)^{-1} X^{\prime} X \hat{\beta}\)

\(Var(\hat{\beta_{\lambda}}) = (X^{\prime} X + \lambda I)^{-1} X^{\prime} X Var(\hat{\beta_{\lambda}}) ((X^{\prime} X + \lambda I)^{-1} X^{\prime} X)^{\prime} \\ = (X^{\prime} X + \lambda I)^{-1} X^{\prime} X \sigma^2 (X^{\prime} X)^{-1} X^{\prime} X (X^{\prime} X + \lambda I)^{-1} \\ = \sigma^{2} (X^{\prime} X + \lambda I)^{-1} X^{\prime} X (X^{\prime} X + \lambda I)^{-1}\)

We set \(W = X^{\prime} X (X^{\prime} X + \lambda I)^{-1}\)

\(Var(\hat{\beta_{\lambda}}) = \sigma^2 (X^{\prime} X + \lambda I)^{-1} X^{\prime} X (X^{\prime} X + \lambda I)^{-1} \\ \sigma^{2} W^{\prime} (X^{\prime} X)^{-1} W\)

Difference:
\(Var(\hat{\beta}) - Var(\hat{\beta_{\lambda}}) = \sigma^{2} (X^{\prime} X)^{-1} - \sigma^{2} W^{\prime} (X^{\prime} X)^{-1} W \\ = \sigma^2 \{ W^{\prime} (W^{\prime})^{-1} (X^{\prime} X)^{-1} W^{\prime} W - W^{\prime} (X^{\prime} X)^{-1} W \} \\ = \sigma^{2} W^{\prime} \{ (W^{\prime})^{-1} (X^{\prime} X)^{-1} W^{-1} - (X^{\prime} X)^{-1} \} W \\ = \sigma^{2} W^{\prime} \{ (X^{\prime} X)^{-1} (X^{\prime} X + \lambda I) (X^{\prime} X)^{-1} (X^{\prime} X + \lambda I) (X^{\prime} X)^{-1} - (X^{\prime} X)^{-1} \} W \\ = \sigma^2 W^{\prime} \{ (I + \lambda (X^{\prime} X)^{-1}) (X^{\prime} X)^{-1} (I + \lambda (X^{\prime} X)^{-1}) - (X^{\prime} X)^{-1} \} W \\ = \sigma^2 W^{\prime} \{ ((X^{\prime} X)^{-1} + \lambda (X^{\prime} X)^{-2}) (I + \lambda (X^{\prime} X)^{-1}) - (X^{\prime} X)^{-1} \} W \\ = \sigma^2 W^{\prime} \{ (X^{\prime} X)^{-1} + \lambda (X^{\prime} X)^{-2} + \lambda (X^{\prime} X)^{-2} + \lambda^2 (X^{\prime} X)^{-3} - (X^{\prime} X)^{-1} \} W \\ = \sigma^2 W^{\prime} \{ 2 \lambda (X^{\prime} X)^{-2} + \lambda^2 (X^{\prime} X)^{-3} \} W \\ = \sigma^2 (X^{\prime} X + \lambda I)^{-1} X^{\prime} X \{ 2 \lambda (X^{\prime} X)^{-2} + \lambda^2 (X^{\prime} X)^{-3} \} X^{\prime} X (X^{\prime} X + \lambda I)^{-1} \\ = \sigma^2 (X^{\prime} X + \lambda I)^{-1} (2 \lambda I + \lambda^2 (X^{\prime} X)^{-1} ) (X^{\prime} X + \lambda I)^{-1}\)

Given that \(\lambda > 0\) then
\(z = (X^{\prime} X + \lambda I)^{-1} \forall V \neq 0\)

Then we have:

\(V^{\prime} \{ Var(\hat{\beta}) - Var(\hat{\beta_{\lambda}}) \} v \\ = \sigma^2 z^{\prime} \{ 2 \lambda I + \lambda^2 (X^{\prime} X)^{-1} \} z \\ = \sigma^2 \lambda z^{\prime} z + \sigma^2 \lambda^2 z^{\prime} (X^{\prime} X)^{-1} z > 0\)

Because \(X^{\prime} X\) and its inverse \((X^{\prime} X)^{-1}\) are
positive definite.
...
We find the \(R^2\) and \(\bar{R^2}\) for the model \emph{modall}:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"R^2: "}\NormalTok{, }\KeywordTok{summary}\NormalTok{(modall)}\OperatorTok{$}\NormalTok{r.squared))}
\CommentTok{#> [1] "R^2:  0.891812495297119"}
\KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Adjusted R^2: "}\NormalTok{, }\KeywordTok{summary}\NormalTok{(modall)}\OperatorTok{$}\NormalTok{adj.r.squared))}
\CommentTok{#> [1] "Adjusted R^2:  0.88266988926589"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{X <-}\StringTok{ }\KeywordTok{model.matrix}\NormalTok{(hwfat }\OperatorTok{~}\NormalTok{., }\DataTypeTok{data=}\NormalTok{bodyfat)}
\NormalTok{fit.ridge <-}\StringTok{ }\KeywordTok{glmnet}\NormalTok{(X, bodyfat}\OperatorTok{$}\NormalTok{hwfat, }\DataTypeTok{alpha=}\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

We perform \(CV\) to calculate the \(R^2\) and \(\bar{R^2}\) for our
ridge model, first the \(R^2\):

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv.out <-}\StringTok{ }\KeywordTok{cv.glmnet}\NormalTok{(X, bodyfat}\OperatorTok{$}\NormalTok{hwfat, }\DataTypeTok{alpha =} \DecValTok{0}\NormalTok{)}
\NormalTok{opt_lambda <-}\StringTok{ }\NormalTok{cv.out}\OperatorTok{$}\NormalTok{lambda.min}
\NormalTok{pred <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit.ridge, }\DataTypeTok{s=}\NormalTok{opt_lambda, }\DataTypeTok{newx=}\NormalTok{X)}
\NormalTok{ridge_rsq <-}\StringTok{ }\NormalTok{(}\KeywordTok{cor}\NormalTok{(pred,bodyfat}\OperatorTok{$}\NormalTok{hwfat))}\OperatorTok{^}\DecValTok{2}
\NormalTok{ridge_rsq}
\CommentTok{#>        [,1]}
\CommentTok{#> 1 0.8882041}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{size <-}\StringTok{ }\KeywordTok{length}\NormalTok{(bodyfat}\OperatorTok{$}\NormalTok{hwfat)}
\NormalTok{variables <-}\StringTok{ }\KeywordTok{length}\NormalTok{(bodyfat)}\OperatorTok{-}\DecValTok{1} 
\NormalTok{ridge_adj_rsq <-}\StringTok{ }\DecValTok{1} \OperatorTok{-}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{-}\NormalTok{ridge_rsq) }\OperatorTok{*}\StringTok{ }\NormalTok{((size}\DecValTok{-1}\NormalTok{)}\OperatorTok{/}\NormalTok{(size}\OperatorTok{-}\NormalTok{variables}\DecValTok{-1}\NormalTok{))}
\NormalTok{ridge_adj_rsq}
\CommentTok{#>        [,1]}
\CommentTok{#> 1 0.8787565}
\end{Highlighting}
\end{Shaded}
