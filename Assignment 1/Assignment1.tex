...
\CommentTok{#> [1] 3.000583 3.010034}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}   }
\CommentTok{#> [1] "beta  1  hat has a relative error of:  0.00019448281837775"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  0.00334467298842345"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(means)}
\CommentTok{#> [1] 2.969735 3.022792}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(means)) \{}
    \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"beta "}\NormalTok{,i, }\StringTok{" hat has a relative error of: "}\NormalTok{, }\KeywordTok{abs}\NormalTok{(means[i]}\OperatorTok{-}\NormalTok{betas[i])}\OperatorTok{/}\NormalTok{betas[i]))}
\NormalTok{\}}
\CommentTok{#> [1] "beta  1  hat has a relative error of:  0.0100883970191926"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  0.0075973650040555"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(means)}
\CommentTok{#> [1]  8.957843 -1.554736}
\end{Highlighting}
\end{Shaded}
...
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(means)) \{}
    \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"beta "}\NormalTok{,i, }\StringTok{" hat has a relative error of: "}\NormalTok{, }\KeywordTok{abs}\NormalTok{(means[i]}\OperatorTok{-}\NormalTok{betas[i])}\OperatorTok{/}\NormalTok{betas[i]))}
\NormalTok{\}}
\CommentTok{#> [1] "beta  1  hat has a relative error of:  1.98594766749838"}
\CommentTok{#> [1] "beta  2  hat has a relative error of:  1.51824543761867"}
\end{Highlighting}
\end{Shaded}
