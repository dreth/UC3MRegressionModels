...
```{r, echo=TRUE, warning=FALSE, message=FALSE, eval=FALSE, fig.show='hide'}
...
We can see a significant improvement in the explained deviance, yielding a 49.7% deviance explained.
